...
try {
	...
	try {
		...
		System.out.println("                       Order Placed!                         ");
				...
				if(cat == "Desk"){
					pw.println("Order cannot be fulfilled based on current inventory. Suggested manufacturers are Office Furnishings, Furniture Goods, and Fine Office Supplies.");
				}
				else if(cat =="Chair"){
					pw.println("Order cannot be fulfilled based on current inventory. Suggested manufacturers are Office Furnishings, Chairs R Us, Furniture Goods, and Fine Office Supplies.");
					...
					pw.println("Order cannot be fulfilled based on current inventory. Suggested manufacturers are Chairs R Us, Furniture Goods, and Fine Office Supplies.");
